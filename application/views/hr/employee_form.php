                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="rate_type" class="form-control">
                                    ...
                                    <option value="2"><?php echo display('monthly')?></option>
                                </select>
                            </div>
                            <label for="hour_rate_or_salary" class="col-sm-2 col-form-div"><?php echo display('hour_rate_or_salary') ?></label>
                            <div class="col-sm-4">
                                <input name="hrate" class="form-control" type="number" placeholder="Leave it empty for the default rate" id="hrate">
                            </div>
