    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input name="date" class="form-control" type="hidden" id="date" value="<?php echo html_escape($data->date)?>" readonly="readonly">
                </div>
            </div> 
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input name="sign_in" class=" form-control" type="hidden"  value="<?php echo $sign_in=html_escape($data->sign_in)?>"  id="sign_in" readonly="readonly" >
                </div>
            </div>
