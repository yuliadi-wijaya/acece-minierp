...
class Chrm extends CI_Controller {
    ...
    public function add_designation() {
        $data['title'] = display('designation');
        $data['sub_title'] = display('add_designation');
        $content = $this->parser->parse('hr/designation_form', $data, true);
    ...
    public function manage_designation() {
        $this->load->model('Hrm_model');
        $data['title']            = display('designation');
        $data['sub_title']        = display('manage_designation');
    ...
    public function designation_update_form($id) {
        $this->load->model('Hrm_model');
        $data['title'] = display('designation');
        $data['sub_title'] = display('update_designation');
    ...
    public function manage_employee() {
        $this->load->model('Hrm_model');
        $data['title']            = display('employee');
        $data['sub_title']            = display('manage_employee');
   ...
   redirect("Chrm/manage_employee");
    ...
    public function employee_details($id) {
        $this->load->model('Hrm_model');
        $data['title']            = display('employee');
         $data['sub_title']            = display('employee_detail');
