...
class Cexpense extends CI_Controller {
    ...
    public function add_expense_item() {
        ...
        $data['sub_title'] = display('add_expense_item');
    ...
    public function expense_statement_form() {
        ...
        $data = array('item_list' => $expense_item,);
    ...
    public function expense_statement() {
        ...
        $expense_item = $this->Expense_model->expense_item_list();
        $data = array('item_list' => $expense_item, 'expense_statement' => $customer_statement, 'from_date' => $from_date, 'to_date' => $to_date, 'expense_id' => $expense_id,);
